...
public static class LevelPreviewBaker
{
    private const string FolderPath = "Assets/_LevelPreview";
    
    // Bakes from the currently selected Camera.
    [MenuItem("Tools/Level Previews/Bake Selected Camera Preview (1:1)")]
    private static void BakeSquare()
    {
        Bake(512, 512);
    }
    
    [MenuItem("Tools/Level Previews/Bake Selected Camera Preview (16:10)")]
