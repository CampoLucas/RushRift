...
Shader "Game/S_TileArray"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_BaseColor( "Color", Color ) = ( 1, 1, 1, 1 )
		[Header(Base Texture)][Texture2DArray] _TexArray( "Texture", 2DArray ) = "white" {}
		_Tiling( "Tiling", Vector ) = ( 1, 1, 1, 1 )
		_TilingScale( "Tiling Scale", Float ) = 0
		[Header(ARME Texture)][Texture2DArray] _TexArrayARME( "ARME", 2DArray ) = "black" {}
		[Header(Roughness)] _RoughnessIntensity( "Intensity", Range( 0, 1 ) ) = 0
		[Header(Emisive)] _EmisiveIntensity( "Intensity", Range( 0, 1 ) ) = 1
		[HDR] _EmisiveColor( "Color", Color ) = ( 0, 0, 0, 0 )
		[Header(Metalic)] _MetalicIntensity( "Intensity", Range( 0, 1 ) ) = 1
		[Header(Slice Settings)] _SliceCount( "Slice Count", Range( 1, 64 ) ) = 1
		[Toggle] _RandomSlice( "Random Slice", Float ) = 0.5
		_SliceIndex( "Slice Index", Int ) = 0
		[Header(Rotation Settings)] _Rotation( "Rotation", Range( 0, 3 ) ) = 0
		[Toggle] _RandomRotation( "Random Rotation", Float ) = 0.5
		[Header(Tile Settings)] _BrightnessVariation( "Brightness Variation", Range( 0, 1 ) ) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "../_Function/HLSL/TileArray_TiledSample.hlsl"
			...
			TEXTURE2D_ARRAY(_TexArrayARME);
			SAMPLER(sampler_TexArrayARME);
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;238;-3216,96;Inherit;False;356;162.6667;AO;1;85;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;117;-7920,-928;Inherit;False;902;1104.667;Properties;26;142;131;132;130;129;41;38;26;30;28;15;35;40;39;36;34;31;21;29;24;19;20;16;22;143;144;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;22;-7328,-672;Inherit;False;slice_index;-1;True;1;0;INT;0;False;1;INT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;16;-7328,-880;Inherit;False;slice_count;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;20;-7520,-768;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;19;-7328,-768;Inherit;False;use_random_slice;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;24;-7504,-576;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;29;-7312,-464;Inherit;False;rotation;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;21;-7488,-672;Inherit;False;Property;_SliceIndex;Slice Index;12;0;Create;True;0;0;0;False;0;False;0;0;False;0;0;0;1;INT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;31;-7312,-368;Inherit;False;brightness_variation;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CeilOpNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;132;-7664,-576;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;131;-7904,-576;Inherit;False;Property;_RandomRotation;Random Rotation;14;1;[Toggle];Create;True;0;0;0;False;0;False;0.5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;137;-8560,-64;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;138;-8320,-64;Inherit;False;base_uv;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;36;-7328,-80;Inherit;False;tile_inset;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;39;-7328,0;Inherit;False;seed;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;40;-7328,80;Inherit;False;color_space_comp;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;35;-7648,-80;Inherit;False;Property;_TileIsetTexels;Tile Iset Texels;16;0;Create;True;0;0;0;False;0;False;0;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;38;-7552,0;Inherit;False;Property;_Seed;Seed;17;0;Create;True;0;0;0;False;0;False;0;1234;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;85;-3168,144;Inherit;False;Property;_AOIntensity;Intensity;5;1;[Header];Create;False;1;AO;0;0;False;0;False;0;0.534;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;237;-3040,-48;Inherit;False;Property;_InvertRoughness;Invert;20;1;[Toggle];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;227;-3104,-1808;Inherit;False;16;slice_count;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;228;-3104,-1744;Inherit;False;22;slice_index;1;0;OBJECT;;False;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;229;-3104,-1680;Inherit;False;29;rotation;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;230;-3104,-1616;Inherit;False;34;tiling;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;231;-3104,-1552;Inherit;False;36;tile_inset;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;232;-3104,-1488;Inherit;False;39;seed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;233;-3168,-1424;Inherit;False;31;brightness_variation;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;243;-2960,-1248;Inherit;False;223;tex_array_ss;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;244;-2960,-1168;Inherit;False;221;base_color;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;242;-2960,-1328;Inherit;False;222;tex_array;1;0;OBJECT;;False;1;SAMPLER2DARRAY;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;245;-2944,-1088;Inherit;False;234;tex_array_arme;1;0;OBJECT;;False;1;SAMPLER2DARRAY;0
Node;AmplifyShaderEditor.GetLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;246;-2944,-1008;Inherit;False;235;tex_array_ss_arme;1;0;OBJECT;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;221;-7408,-1744;Inherit;False;base_color;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;222;-7408,-1520;Inherit;False;tex_array;-1;True;1;0;SAMPLER2DARRAY;0,0,0,0;False;1;SAMPLER2DARRAY;0
...
WireConnection;221;0;10;0
WireConnection;222;0;53;0
WireConnection;223;0;53;1
WireConnection;234;0;52;0
WireConnection;235;0;52;1
WireConnection;218;2;217;10
WireConnection;218;3;217;11
