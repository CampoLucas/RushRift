...
Shader "S_Depth"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "../../_Function/HLSL/DepthFunctions.hlsl"
						 ...
						 ) : SV_Target
			{
				...
				float4 fetchOpaqueVal53 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ase_grabScreenPosNorm.xy ), 1.0 );
				float2 uv11 = ScreenPosNorm.xy;
				float localget_linear_01depth11 = get_linear_01depth( uv11 );
				float4 lerpResult55 = lerp( fetchOpaqueVal53 , _Color0 , saturate( ( ( localget_linear_01depth11 - _Start ) / _End ) ));
...
ASEEND*/
//CHKSM=1E3D98095C629BCFFCE7EB56EFA7FD0B279DB5F4