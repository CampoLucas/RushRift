...
Shader "S_Holo Level Cover"
{
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #include "../../_Function/HLSL/ParallaxSharp.hlsl"
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float3 viewDirTS278 = ase_viewDirTS;
                sampler2D heightTex278 = _BorderMask;
                float4 channelSelect278 = float4( 1,0,0,0 );
                float heightScale278 = _Depth;
                float steps278 = _Float4;
                float threshold278 = _Float5;
                float invert278 = 0.0;
                float wallMask278 = 0.0;
                float4 wallColor278 = float4( 0,0,0,0 );
                float2 localParallaxSharpUV278 = ParallaxSharpUV( uv278 , viewDirTS278 , heightTex278 , channelSelect278 , heightScale278 , steps278 , threshold278 , invert278 , wallMask278 , wallColor278 );
                float2 parallax_uv299 = localParallaxSharpUV278;
                ...
                float border_red248 = tex2DNode63.r;
                float2 lerpResult304 = lerp( parallax_uv299 , uv48 , border_red248);
                float2 temp_cast_1 = (_Float1).xx;
                float mulTime95 = _Time.y * _Float2;
                float2 temp_cast_2 = (mulTime95).xx;
                float2 temp_output_4_0_g18 = ( ( lerpResult304 * temp_cast_1 ) + temp_cast_2 );
                float smoothstepResult112 = smoothstep( _Vector0.x , _Vector0.y , tex2D( _TextureSample1, temp_output_4_0_g18 ).r);
                float2 temp_cast_3 = (_BorderOutlineOutter).xx;
                float2 temp_output_4_0_g15 = ( ( uv48 * float2( 1,1 ) ) + temp_cast_3 );
                float temp_output_184_0 = ( _BorderOutlineOutter * -1.0 );
                float2 temp_cast_4 = (temp_output_184_0).xx;
                float2 temp_output_4_0_g14 = ( ( uv48 * float2( 1,1 ) ) + temp_cast_4 );
                ...
                float lerpResult139 = lerp( 0.0 , ( tex2D( _BorderMask, temp_output_4_0_g15 ).r * tex2D( _BorderMask, temp_output_4_0_g14 ).r * tex2D( _BorderMask, temp_output_4_0_g16 ).r * tex2D( _BorderMask, temp_output_4_0_g17 ).r ) , border_red248);
                ...
                float border_blue249 = tex2DNode63.b;
                float lerpResult194 = lerp( saturate( ( ( border_red248 - tex2D( _BorderMask, temp_output_4_0_g10 ).r ) + ( border_red248 - tex2D( _BorderMask, temp_output_4_0_g11 ).r ) + ( border_red248 - tex2D( _BorderMask, temp_output_4_0_g12 ).r ) + ( border_red248 - tex2D( _BorderMask, temp_output_4_0_g13 ).r ) ) ) , 0.0 , border_blue249);
                ...
                float walls289 = wallMask278;
                float temp_output_2_0_g24 = walls289;
                float lerpResult302 = lerp( ( smoothstepResult112 + border_outline173 ) , 0.0 , (temp_output_2_0_g24).x);
                float lines120 = lerpResult302;
                ...
                float lerpResult296 = lerp( image58 , 0.0 , walls289);
                float lerpResult65 = lerp( lerpResult296 , 0.0 , border_red248);
                float lerped_image87 = lerpResult65;
                float image_w_lines107 = ( lines120 + lerped_image87 );
                float4 lerpResult77 = lerp( _BackgroundColor , float4( (temp_output_2_0_g28).rgb , 0.0 ) , image_w_lines107);
...
Node;AmplifyShaderEditor.CommentaryNode;81;-4189.228,96;Inherit;False;1639.896;507.2319;Ceparate the image from the border;8;82;87;65;249;248;63;281;279;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;55;-4534.453,-1584;Inherit;False;1315.779;238.5679;Cach uv;3;299;48;6;;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;279;-4080,208;Inherit;True;Property;_BorderMask;Border Mask;14;0;Create;True;0;0;0;False;0;False;None;463354571c0f29942a3a22e023aa3f69;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;210;-5184,3600;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;-1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;6;-4480,-1520;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;281;-3792,224;Inherit;False;border_tex;-1;True;1;0;SAMPLER2D;;False;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;48;-4144,-1520;Inherit;False;uv;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;63;-3568,224;Inherit;True;Property;_BorderTex;BorderTex;4;0;Create;True;0;0;0;False;0;False;-1;None;463354571c0f29942a3a22e023aa3f69;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode;248;-3232,224;Inherit;False;border_red;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;252;-4336,3024;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;254;-4336,3392;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;256;-4320,3728;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;258;-4336,4096;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;249;-3232,304;Inherit;False;border_blue;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;282;-4304,-1168;Inherit;False;281;border_tex;1;0;OBJECT;;False;1;SAMPLER2D;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;283;-4304,-1312;Inherit;False;Tangent;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;284;-4304,-1088;Inherit;False;Property;_Depth;Depth;15;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;285;-4272,-1008;Inherit;False;Property;_Float4;Float 3;16;0;Create;True;0;0;0;False;0;False;0;32;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;286;-4288,-928;Inherit;False;Property;_Float5;Float 3;17;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;251;-3792,3600;Inherit;False;249;border_blue;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;250;-3920,2320;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;278;-3904,-1280;Inherit;False; ;2;File;10;False;uv;FLOAT2;0,0;In;;Inherit;False;False;viewDirTS;FLOAT3;0,0,0;In;;Inherit;False;False;heightTex;SAMPLER2D;;In;;Inherit;False;True;channelSelect;FLOAT4;1,0,0,0;In;;Inherit;False;True;heightScale;FLOAT;1;In;;Inherit;False;True;steps;FLOAT;8;In;;Inherit;False;True;threshold;FLOAT;1;In;;Inherit;False;True;invert;FLOAT;0;In;;Inherit;False;True;wallMask;FLOAT;0;Out;;Inherit;False;True;wallColor;FLOAT4;0,0,0,0;Out;;Inherit;False;ParallaxSharpUV;False;False;0;9aad0d6943184586a85efe28406eb32f;False;10;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;2;SAMPLER2D;;False;3;FLOAT4;1,0,0,0;False;4;FLOAT;1;False;5;FLOAT;8;False;6;FLOAT;1;False;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT4;0,0,0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT4;10
Node;AmplifyShaderEditor.CommentaryNode;111;-5289.946,704;Inherit;False;2744.875;651.3332;Lines;20;107;99;97;120;302;301;155;300;153;112;114;90;276;277;95;93;96;304;303;306;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;299;-3456,-1488;Inherit;False;parallax_uv;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;96;-5312,1024;Inherit;False;Property;_Float2;Float 2;8;0;Create;True;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;303;-4848,1136;Inherit;False;248;border_red;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;306;-5136,832;Inherit;False;48;uv;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;93;-5120,912;Inherit;False;Property;_Float1;Float 1;7;0;Create;True;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;95;-5120,1024;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;175;-3392,2672;Inherit;False;Property;_BorderOutlineIntensity;Border Outline Intensity;13;0;Create;True;0;0;0;False;0;False;0.5;0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;114;-4320,976;Inherit;False;Property;_Vector0;Vector 0;9;0;Create;True;0;0;0;False;0;False;0,0;0.21,1.05;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;289;-3440,-1248;Inherit;False;walls;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;300;-3632,880;Inherit;False;289;walls;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;155;-3712,752;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;301;-3424,880;Inherit;False;Alpha Split;-1;;24;07dab7960105b86429ac8eebd729ed6d;0;1;2;FLOAT;0;False;2;FLOAT3;0;FLOAT;6
...
Node;AmplifyShaderEditor.LerpOp;302;-3296,752;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;120;-3104,752;Inherit;False;lines;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;290;-3920,-128;Inherit;False;289;walls;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;62;-3712,-16;Inherit;False;58;image;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;296;-3520,-128;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;65;-2976,144;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;87;-2816,144;Inherit;False;lerped_image;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;97;-3216,992;Inherit;False;87;lerped_image;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;99;-2880,752;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;110;-3477.408,1312;Inherit;False;969.4077;438.77;Alpha;5;84;106;86;105;109;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;107;-2752,752;Inherit;False;image_w_lines;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;109;-3280,1472;Inherit;False;107;image_w_lines;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;105;-3056,1472;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;86;-3184,1360;Inherit;False;Property;_Alpha;Alpha;5;0;Create;True;0;0;0;False;0;False;0.58;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;79;-1440,-768;Inherit;False;708;465.3333;Apply Color;5;78;71;70;77;108;;1,1,1,1;0;0
Node;AmplifyShaderEditor.LerpOp;106;-2896,1360;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;80;-624,-128;Inherit;False;298.3685;342.7713;Alpha Mask;3;83;74;85;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;84;-2752,1392;Inherit;False;alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;70;-1392,-512;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RegisterLocalVarNode;82;-3232,384;Inherit;False;alpha_mask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;71;-1168,-512;Inherit;False;Alpha Split;-1;;28;07dab7960105b86429ac8eebd729ed6d;0;1;2;COLOR;0,0,0,0;False;2;FLOAT3;0;FLOAT;6
Node;AmplifyShaderEditor.ColorNode;78;-1200,-720;Inherit;False;Property;_BackgroundColor;Background Color;6;0;Create;True;0;0;0;False;0;False;0.0754717,0.03773584,0.03773584,0;0.3018867,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;108;-1200,-400;Inherit;False;107;image_w_lines;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;74;-512,-80;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;77;-880,-624;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;60;0,-272;Inherit;False;result;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;59;-48,16;Inherit;False;60;result;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;297;-3712,-192;Inherit;False;Alpha Split;-1;;27;07dab7960105b86429ac8eebd729ed6d;0;1;2;FLOAT;0;False;2;FLOAT3;0;FLOAT;6
...
WireConnection;302;0;155;0
WireConnection;302;2;301;6
WireConnection;120;0;302;0
...
WireConnection;296;0;62;0
WireConnection;296;2;290;0
WireConnection;65;0;296;0
...
ASEEND*/
//CHKSM=DF4F4C32D11ECBFE15BFB91B3DFBF3FF74BE9263