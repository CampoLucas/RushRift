...
Shader "S_PopUp"
{
    Properties
    {
        ...
        _BorderScale("BorderScale", Vector) = (1,1,0,0)
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float2 temp_output_150_0 = ( _BorderWidthMax * _BorderScale );
                float2 smoothstepResult14_g16 = smoothstep( temp_output_150_0 , ( _BorderWidthMin * _BorderScale ) , temp_output_6_0_g16);
                float2 lerpResult17_g16 = lerp( step( temp_output_6_0_g16 , temp_output_150_0 ) , smoothstepResult14_g16 , (float)1);
                float2 break8_g16 = lerpResult17_g16;
                float2 temp_output_6_0_g17 = ( 1.0 - ( saturate( abs( ( ( Coords42 * float2( 2,2 ) ) - float2( 1,1 ) ) ) ) - float2( 1,1 ) ) );
                float2 smoothstepResult14_g17 = smoothstep( float2( 2,2 ) , float2( 2,2 ) , temp_output_6_0_g17);
                float2 lerpResult17_g17 = lerp( step( temp_output_6_0_g17 , ( _BorderWidth * _BorderScale ) ) , smoothstepResult14_g17 , (float)0);
                float2 break8_g17 = lerpResult17_g17;
                float temp_output_144_0 = saturate( ( break8_g17.x + break8_g17.y ) );
                ...
                float2 break20_g18 = Coords42;
                float lerpResult11_g18 = lerp( break20_g18.x , break20_g18.y , _Horizontal);
                float temp_output_3_0_g18 = ( frac( ( ( lerpResult11_g18 * _Frequency ) + ( _LineSpeed * _Time.y ) ) ) * _Amplitude );
                float temp_output_15_0_g18 = _Width;
                float lerpResult13_g18 = lerp( temp_output_3_0_g18 , step( temp_output_3_0_g18 , temp_output_15_0_g18 ) , ceil( temp_output_15_0_g18 ));
                float lerpResult146 = lerp( 0.0 , lerpResult13_g18 , _UseLines);
                float3 ase_positionWS = IN.ase_texcoord3.xyz;
                float2 temp_cast_4 = (( _Time.y * _NoiseSpeed )).xx;
                float2 temp_output_4_0_g8 = ( ( ase_positionWS.xy * float2( 1,1 ) ) + temp_cast_4 );
                float simplePerlin2D39 = snoise( temp_output_4_0_g8*_NoiseScale );
                simplePerlin2D39 = simplePerlin2D39*0.5 + 0.5;
                float lerpResult38 = lerp( 0.0 , lerpResult146 , (_NoiseMinAlpha + (simplePerlin2D39 - 0.0) * (_NoiseMaxAlpha - _NoiseMinAlpha) / (1.0 - 0.0)));
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.CommentaryNode;58;-3872,912;Inherit;False;3107.079;977.0483;Lines Mask;10;147;146;110;106;107;111;38;57;56;152;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;56;-3088,1488;Inherit;False;1188;371;Noise;11;50;55;45;54;49;46;39;52;53;51;139;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;103;-2103.5,0;Inherit;False;1384.824;625.8958;Border;14;148;149;143;105;104;109;145;141;144;142;72;99;150;151;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleTimeNode;50;-3024,1616;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-3024,1696;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;5;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;42;-1536,-384;Inherit;False;Coords;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;57;-3184,960;Inherit;False;821;419;Lines;8;47;122;30;26;37;43;123;124;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-2000,128;Inherit;False;Property;_BorderWidthMax;BorderWidthMax;8;0;Create;True;0;0;0;False;0;False;0;1.43;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;142;-2000,208;Inherit;False;Property;_BorderWidthMin;BorderWidthMin;9;0;Create;True;0;0;0;False;0;False;0;0.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;143;-1984,448;Inherit;False;Property;_BorderWidth;BorderWidth;10;0;Create;True;0;0;0;False;0;False;0;0.95;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;148;-1968,304;Inherit;False;Property;_BorderScale;BorderScale;15;0;Create;True;0;0;0;False;0;False;1,1;1.07,1.3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-2832,1616;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;123;-3120,1232;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;124;-3088,1152;Inherit;False;Property;_LineSpeed;LineSpeed;11;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;139;-3056,1520;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;150;-1744,128;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;151;-1744,224;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-1744,320;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;49;-2640,1536;Inherit;False;F_TillingAndOffset;-1;;8;992a7dac1d94f9a47be7a2d63002dd82;0;3;1;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;7;FLOAT;10
Node;AmplifyShaderEditor.RangedFloatNode;46;-2608,1664;Inherit;False;Property;_NoiseScale;NoiseScale;4;0;Create;True;0;0;0;False;0;False;0;-0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;37;-2944,1296;Inherit;False;Property;_Width;Width;3;0;Create;True;0;0;0;False;0;False;0;0.08073624;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-2816,1136;Inherit;False;Property;_Amplitude;Amplitude;2;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;122;-2928,1200;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2816,1072;Inherit;False;Property;_Frequency;Frequency;1;0;Create;True;0;0;0;False;0;False;0;60;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;144;-1504,256;Inherit;False;F_BorderMask;-1;;17;5e46f25ec17629e41a65d4b125b40423;0;5;12;FLOAT2;0,0;False;11;FLOAT2;2,2;False;15;FLOAT2;2,2;False;16;FLOAT2;2,2;False;18;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;152;-2729.474,1409.597;Inherit;False;Property;_Horizontal;Horizontal;16;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;43;-2848,1008;Inherit;False;42;Coords;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;39;-2384,1536;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-2416,1664;Inherit;False;Property;_NoiseMinAlpha;NoiseMinAlpha;6;0;Create;True;0;0;0;False;0;False;0.3804348;0.3804348;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-2416,1744;Inherit;False;Property;_NoiseMaxAlpha;NoiseMaxAlpha;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;47;-2624,1088;Inherit;False;F_FracMask;-1;;18;cebeb8626740bc9488921f98d538d211;0;6;6;FLOAT2;0,0;False;7;FLOAT;100;False;9;FLOAT;1;False;8;FLOAT;0;False;12;FLOAT;1;False;15;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;147;-2320,1184;Inherit;False;Property;_UseLines;UseLines;14;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;51;-2096,1536;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;146;-2128,1072;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;38;-1760,1056;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-1536,1056;Inherit;False;BackgroundMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;125;976,16;Inherit;False;Property;_BackgroundColor;BackgroundColor;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2941176,0.2941176,0.2941176,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.GetLocalVarNode;45;-2864,1536;Inherit;False;42;Coords;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;107;-1520,1216;Inherit;False;6;SecondaryColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;106;-1280,1056;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;110;-1120,1056;Inherit;False;Background;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;141;15;150;0
WireConnection;141;16;151;0
WireConnection;122;0;124;0
WireConnection;122;1;123;0
WireConnection;144;12;99;0
WireConnection;144;11;149;0
...
ASEEND*/
//CHKSM=27DE22874E8A49B1022B72DE3485CA4D446D1F42