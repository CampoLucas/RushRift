    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN ) : SV_Target
            {
                ...
                float2 temp_cast_1 = (_BorderWidth).xx;
                float2 break8_g10 = step( ( 1.0 - ( saturate( abs( ( ( Coords42 * float2( 2,2 ) ) - float2( 1,1 ) ) ) ) - float2( 1,1 ) ) ) , temp_cast_1 );
                float BorderMask109 = saturate( ( break8_g10.x + break8_g10.y ) );
                float4 lerpResult118 = lerp( SecondaryColor6 , Color5 , BorderMask109);
                float4 break117 = lerpResult118;
                float2 break20_g11 = Coords42;
                float lerpResult11_g11 = lerp( break20_g11.x , break20_g11.y , 1.0);
                float temp_output_3_0_g11 = ( frac( ( ( lerpResult11_g11 * _Frequency ) + ( _LineSpeed * _Time.y ) ) ) * _Amplitude );
                float temp_output_15_0_g11 = _Width;
                float lerpResult13_g11 = lerp( temp_output_3_0_g11 , step( temp_output_3_0_g11 , temp_output_15_0_g11 ) , ceil( temp_output_15_0_g11 ));
                float3 ase_positionWS = IN.ase_texcoord3.xyz;
                float2 temp_cast_3 = (( _Time.y * _NoiseSpeed )).xx;
                float simplePerlin2D39 = snoise( ( ( ase_positionWS.xy * float2( 1,1 ) ) + temp_cast_3 )*_NoiseScale );
                simplePerlin2D39 = simplePerlin2D39*0.5 + 0.5;
                float lerpResult38 = lerp( 0.0 , lerpResult13_g11 , (0.0 + (simplePerlin2D39 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)));
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.CommentaryNode;58;-3152,352;Inherit;False;2254.279;890.6484;Lines Mask;8;110;106;107;38;56;57;111;139;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;56;-3104,848;Inherit;False;1188;371;Noise;10;50;55;45;54;49;46;39;52;53;51;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;50;-3056,976;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-3056,1056;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;5;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;42;-1536,-384;Inherit;False;Coords;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-2864,976;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;57;-2819,400;Inherit;False;821;419;Lines;8;47;122;30;26;37;43;123;124;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;103;-1824,32;Inherit;False;935.324;282.3958;Border;6;104;109;105;99;72;102;;1,1,1,1;0;0
Node;AmplifyShaderEditor.VertexColorNode;2;-1808,-224;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;139;-3136,672;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;49;-2672,896;Inherit;False;F_TillingAndOffset;-1;;8;992a7dac1d94f9a47be7a2d63002dd82;0;3;1;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-2640,1024;Inherit;False;Property;_NoiseScale;NoiseScale;4;0;Create;True;0;0;0;False;0;False;0;-0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;123;-2754,672;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;124;-2720,592;Inherit;False;Property;_LineSpeed;LineSpeed;7;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1776,160;Inherit;False;Property;_BorderWidth;BorderWidth;6;0;Create;True;0;0;0;False;0;False;0;1.03;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;99;-1776,80;Inherit;False;42;Coords;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;39;-2416,896;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-2432,1024;Inherit;False;Constant;_NoiseMinAlpha;NoiseMinAlpha;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;-2432,1104;Inherit;False;Constant;_NoiseMaxAlpha;NoiseMaxAlpha;5;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;43;-2482,448;Inherit;False;42;Coords;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;37;-2578,736;Inherit;False;Property;_Width;Width;3;0;Create;True;0;0;0;False;0;False;0;0.08073624;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-2450,576;Inherit;False;Property;_Amplitude;Amplitude;2;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;122;-2562,640;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-2450,512;Inherit;False;Property;_Frequency;Frequency;1;0;Create;True;0;0;0;False;0;False;0;60;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;102;-1536,80;Inherit;False;F_BorderMask;-1;;10;5e46f25ec17629e41a65d4b125b40423;0;2;12;FLOAT2;0,0;False;11;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;51;-2128,896;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;47;-2258,528;Inherit;False;F_FracMask;-1;;11;cebeb8626740bc9488921f98d538d211;0;6;6;FLOAT2;0,0;False;7;FLOAT;100;False;9;FLOAT;1;False;8;FLOAT;0;False;12;FLOAT;1;False;15;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;109;-1312,80;Inherit;False;BorderMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;38;-1888,496;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;111;-1664,496;Inherit;False;BackgroundMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;125;976,16;Inherit;False;Property;_BackgroundColor;BackgroundColor;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.245283,0.245283,0.245283,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;136;1392,464;Inherit;False;Property;_AlphaOffset;AlphaOffset;9;0;Create;True;0;0;0;False;0;False;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;45;-2896,896;Inherit;False;42;Coords;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;104;-1056,80;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;107;-1648,656;Inherit;False;6;SecondaryColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;106;-1408,496;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;110;-1248,496;Inherit;False;Background;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;105;-1280,208;Inherit;False;5;Color;1;0;OBJECT;;False;1;COLOR;0
...
WireConnection;102;12;99;0
WireConnection;102;11;72;0
...
ASEEND*/
//CHKSM=DA29ACD106465CC7C95536F3C1693EA986021EE8